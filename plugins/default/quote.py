...
resnew = requests.get('https://api.vk.com/method/messages.getById?access_token='+token+'&v=5.68&message_ids='+str(longpoll[userid]['object']['id'])).text
#print(resnew)
...
img.save('img/quote/'+str(userid)+'.jpg')
sendpic('img/quote/'+str(userid)+'.jpg','',toho)